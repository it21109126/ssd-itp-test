...
useEffect(() => {
  const fetchDeliveries = async () => {
    ...
    // const deliverycompletedCount = await fetch('deliveryCompleted/count')
    ...
    if (response.ok) {
      ...
      setPiechart({ series: countdata, 
        options: { chart: { width: 380, type: 'pie', }, 
...
return (
  <div>
    ...
    <main className="main" id="main">
      ...
      <div className='row'>
        <div class="card col-6" style={{ marginRight: 10 }}>
          <div class="card-body">
          <Chart
