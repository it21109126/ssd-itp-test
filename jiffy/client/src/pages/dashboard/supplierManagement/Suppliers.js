    ...
    return (
        <>
            ...
            <main className="main" id="main">
                ...
                <Link to={{ pathname: '/add-supplier-payment' }}><button className="btn btn-primary" style={{ float: "right", margin: "0 20px" }}><i className="bi bi-cash-stack"></i><span style={{ margin: "0 10px", color: "#FFF" }}>Add Supplier Payment Info</span></button></Link>
                ...
                />
                {/* <button className="btn btn-primary"><Link to="/add-supplier" style={{ color: "white" }}>Add Supplier</Link></button> */}
            </main>
        </>
    )
}
