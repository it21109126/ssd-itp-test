                                            ...
                                            suppliers.map((supplier) => {
                                                return (
                                                    <tr key={supplier._id}>
                                                        ...
                                                        <td><Link to={{ pathname: `/supplier-payment-info/${supplier.companyName}/${supplier.rawMaterial}` }}><button className="btn btn-primary" title="View payment details"><i className="bi bi-file-earmark-text-fill"></i></button></Link></td>
                                                    </tr>
                                                );
                                            })}
                                    </tbody>
